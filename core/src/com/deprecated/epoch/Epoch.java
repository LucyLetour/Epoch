...
public class Epoch extends Game {
	...
	public static com.ender.games.epoch.GameManager gameManager;
	...
	public void create () {
		...
		gameManager = com.ender.games.epoch.GameManager.getInstance();
		...
		//TODO
		initializeScreens();
		gameManager.setGameState(com.ender.games.epoch.GameManager.GameState.IN_GAME);
	}
